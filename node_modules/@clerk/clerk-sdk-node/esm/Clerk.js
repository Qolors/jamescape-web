import { AuthStatus, Base, ClerkAPIResponseError, ClerkBackendAPI, createGetToken, createSignedOutState, Logger, } from '@clerk/backend-core';
        ...
        super({
            ...
            apiClient: {
                async request(options) {
                    ...
                    const response = await fetch(finalUrl.href, deepmerge(httpOptions, {
                        method,
