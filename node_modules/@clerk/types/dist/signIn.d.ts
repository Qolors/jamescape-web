...
import { EmailCodeStrategy, EmailLinkStrategy, OAuthStrategy, PasswordStrategy, PhoneCodeStrategy, TicketStrategy, TOTPStrategy, Web3Strategy } from './strategies';
...
export declare type SignInSecondFactor = PhoneCodeFactor | TOTPFactor;
...
export declare type AttemptSecondFactorParams = PhoneCodeAttempt | TOTPAttempt;
...
export declare type SignInStrategy = PasswordStrategy | PhoneCodeStrategy | EmailCodeStrategy | EmailLinkStrategy | TicketStrategy | Web3Strategy | TOTPStrategy | OAuthStrategy;
