...
declare type Attribute = 'email_address' | 'phone_number' | 'username' | 'first_name' | 'last_name' | 'password' | 'web3_wallet' | 'authenticator_app';
export declare type VerificationStrategy = 'email_link' | 'email_code' | 'phone_code' | 'totp';
