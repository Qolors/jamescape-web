...
export declare class Client {
    ...
    constructor(id: string, sessionIds: string[], sessions: Session[], signInAttemptId: string | null, signUpAttemptId: string | null, signInId: string | null, signUpId: string | null, lastActiveSessionId: string | null, createdAt: number, updatedAt: number);
